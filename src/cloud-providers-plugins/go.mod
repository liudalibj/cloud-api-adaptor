module github.com/confidential-containers/cloud-api-adaptor/src/cloud-providers-plugins

go 1.20

require github.com/confidential-containers/cloud-api-adaptor/src/cloud-providers v0.8.0
